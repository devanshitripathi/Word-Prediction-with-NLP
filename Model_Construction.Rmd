...
# Introduction
Language model construction, an application that will predict the next word in the input

1. Reading and cleaning data.
2. Construct a 5-gram model
...
# Since, the data is large, it is taking long time to download directly into R. So this was downloaded locally and then loaded
blogsFile = file.path("D:/Words_Data/en_US","en_US.blogs.txt")
newsFile = file.path("D:/Words_Data/en_US","en_US.news.txt")
twitterFile = file.path("D:/Words_Data/en_US","en_US.twitter.txt")
...
filteredWordsFile = "D:/data/Profanity.txt"
...
## and the function to translate from word to code and back
